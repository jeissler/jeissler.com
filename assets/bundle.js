...
var _scrollmagic = __webpack_require__(328);
...
var scene = new _scrollmagic2.default.Scene({ offset: 250, reverse: false }).setClassToggle("#callouts .icon-block", "active");
controller.addScene(scene);

var scene2 = new _scrollmagic2.default.Scene({ triggerElement: '#contact p', reverse: false }).setClassToggle("#contact>div>:not(:first-child)", "active");
controller.addScene(scene2);

var scene3 = new _scrollmagic2.default.Scene({ triggerElement: '#callouts', reverse: false }).setClassToggle("#callouts i", "active");
controller.addScene(scene3);

var scene4 = new _scrollmagic2.default.Scene({ triggerElement: '#skills .skills-header', reverse: false }).setClassToggle("#skills .bar-inner", "active");
